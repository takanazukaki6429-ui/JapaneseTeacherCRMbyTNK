                    ...
                    <div className="flex items-center gap-2">
                        {hasRoadmap && (
                            <button
                                ...
                                className="text-xs font-bold text-white bg-[#6b5ca5] hover:opacity-90 px-3 py-1.5 rounded-xl transition-opacity flex items-center gap-1"
                            >
                                <Send size={12} /> 生徒に渡す
                            </button>
                        )}
            ...
            <div className="max-w-2xl mx-auto p-4 md:p-6 space-y-5">
                ...
                {hasRoadmap && shareOpen && (
                    <div className="bg-white rounded-2xl p-5 shadow-[0_0_40px_rgba(107,92,165,0.06)] space-y-3">
                        <div>
                            <p className="text-sm font-bold text-[#3a3350]">{student.name}さんに渡すリンク</p>
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            <label htmlFor="share-locale" className="text-xs font-bold text-[#484550]">表示する言語</label>
                            <select
                                id="share-locale"
                                value={shareLocale}
                                onChange={e => { setShareLocale(e.target.value as Locale); setShareUrl(''); }}
                                className="text-sm border border-[#e4ddf0] rounded-lg px-2 py-1.5 bg-white"
                            >
                            ...
                            <button
                                ...
                                className="text-sm font-bold text-white bg-[#6b5ca5] hover:opacity-90 disabled:opacity-50 px-4 py-1.5 rounded-lg flex items-center gap-1.5"
                            >
                        ...
                        {shareUrl && (
                            <div className="flex items-center gap-2">
                                <input readOnly value={shareUrl} onFocus={e => e.target.select()} className="flex-1 min-w-0 text-xs border border-[#e4ddf0] rounded-lg px-2 py-2 bg-[#f6f3fb] text-[#3a3350]" />
                                <button type="button" onClick={copyShareUrl} className="text-xs font-bold text-[#6b5ca5] bg-[#efe9ff] hover:bg-[#e7deff] px-3 py-2 rounded-lg flex items-center gap-1 whitespace-nowrap">
                                    {copied ? <Check size={12} /> : <Copy size={12} />} {copied ? 'コピーしました' : 'コピー'}
                                </button>
                                <a href={shareUrl} target="_blank" rel="noopener noreferrer" className="text-xs font-bold text-[#484550] hover:text-[#3a3350] px-2 py-2 flex items-center gap-1 whitespace-nowrap">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-[#484550]">目標レベル: {getLevelDescription(milestone.level, ja)}</p>
                                                </div>
                                            </div>
