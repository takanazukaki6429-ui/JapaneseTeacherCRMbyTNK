            ...
            <CardContent className="p-4 h-64">
                <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={chartData} margin={{ top: 10, right: 30, left: -20, bottom: 0 }}>
                        ...
                        <YAxis domain={[0, 100]} ticks={[10, 30, 50, 70, 90]} tickFormatter={(v) => jlptName(Number(v))} axisLine={false} tickLine={false} tick={{ fontSize: 11, fill: '#9CA3AF' }} />
                        <Tooltip
                    ...
                    <CardContent className="p-4 space-y-3">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-bold text-[#020817]">{milestone.month}{t.monthN || t.monthsLater}</p>
                                </div>
                            </div>
